...
@WebServlet(name = "SvNewCliente", urlPatterns = {"/SvNewCliente"})
public class SvNewCliente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        controlLog.crearCliente(nombre, apellido, dni, fechaNac, direccion, nacionalidad, email, telefono);
