   ...
   <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form action="SvModificarEmpleado2" method="POST">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="nombre" value="<%=empleado.getNombreEmpleado()%>">
                                            <label class="label--desc">Nombre</label>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="apellido" value="<%=empleado.getApellidoEmpleado()%>">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="dni" value="<%=empleado.getDniEmpleado()%>">
                                </div>
                            </div>
                        </div>
                        
                       <% SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                    String fechaString = (empleado.getFechaNacEmpleado()!=null) ? sdf.format(empleado.getFechaNacEmpleado()):" ";
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="direccion" value="<%=empleado.getDireccionEmpleado()%>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="nacionalidad" value="<%=empleado.getNacionalidadEmpleado()%>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="email" name="email" value="<%=empleado.getEmailEmpleado()%>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="telefono" value="<%=empleado.getCelularEmpleado()%>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="cargo" value="<%=empleado.getCargoEmpleado()%>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="sueldo" value="<%=empleado.getSueldoEmpleado()%>">
                                </div>
                            </div>
                        </div>
                        
                                
                         <input class="input--style-5" type="hidden" name="id" value="<%=empleado.getIdEmpleado()%>">      
