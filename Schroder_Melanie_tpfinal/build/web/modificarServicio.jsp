        ...
        <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
            <div class="wrapper wrapper--w790">
                <div class="card card-5">
                    ...
                    <div class="card-body">
                        <form action="SvModificarServicio2" method="POST">

                            <% HttpSession sesion = request.getSession();
                            Servicio srv = (Servicio) miSesion.getAttribute("servicio");
                            {%>
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="nombre" value="<%=srv.getNombreServicio()%>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="descripcion" value="<%=srv.getDescripcionServicio()%>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="destino" value="<%=srv.getDestinoServicio()%>">
                                    </div>
                                </div>
                            </div>        
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="fecha" value="<%=fechaString%>">
                            ...
                            <div class="form-row">
                                <div class="name">Costo</div>
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="costo" value="<%=srv.getCostoServicio()%>">
                                    </div>
                                </div>
                            </div>


                            <input class="input--style-5" type="hidden" name="codigo" value="<%=srv.getCodigoServicio()%>">      
