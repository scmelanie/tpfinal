            ...
            <div class="wrapper wrapper--w790">
                <div class="card card-5">
                    <div class="card-heading">
                        <h3 class="title">Añadir nuevo servicio</h3>
                    </div>
                    <div class="card-body">
                        <form action="SvNewServicio" method="POST">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="destino">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                ...
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="costo">
                                    </div>
                                </div>
                            </div>
                            <div>
                                <button class="btn btn--radius-2 btn--green" type="submit">Añadir Servicio</button>
                            </div>
                        </form>
                    </div>
                </div>
